        ...
        <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <div className="mt-8 flex gap-3 text-offwhite/60">
              <a href="https://www.instagram.com/" target="_blank" rel="noreferrer" aria-label="Instagram" title="Instagram" className="transition-colors hover:text-green">
              ...
              <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" aria-label="LinkedIn" title="LinkedIn" className="transition-colors hover:text-green">
              ...
              <a href="https://www.youtube.com/" target="_blank" rel="noreferrer" aria-label="YouTube" title="YouTube" className="transition-colors hover:text-green">
